// ===================================================================
// CONVEX HULL UTILITIES - WebRay-M Framework Module
// ===================================================================
// Geometric calculations for overlay positioning. Extracted and cleaned
// from muck-rack-sidepanel for use in the WebRay-M framework.
// ===================================================================
...
export function isInConvexHull(point: Point, hullPoints: Point[]): boolean {
  ...
  try {
    ...
    console.warn('Error computing convex hull:', error);
    return false;
  }
}
