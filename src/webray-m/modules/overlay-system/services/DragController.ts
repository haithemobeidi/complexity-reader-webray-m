...
export function createDragController(
  ...
  function updateHandles(): void {
    ...
    handles.forEach(handle => {
      // Mouse events - use generic event listener interface
  ...
  function handleMouseDown(event: MouseEvent): void {
    ...
    eventManager.add(document, 'mousemove', handleMouseMove as EventListener);
    eventManager.add(document, 'mouseup', handleMouseUp as EventListener);
  ...
  function handleTouchStart(event: TouchEvent): void {
    ...
    eventManager.add(document, 'touchmove', handleTouchMove as EventListener);
    eventManager.add(document, 'touchend', handleTouchEnd as EventListener);
    eventManager.add(document, 'touchcancel', handleTouchEnd as EventListener);
  }
  ...
  function handleMouseUp(event: MouseEvent): void {
    ...
    eventManager.remove(document, 'mousemove', handleMouseMove as EventListener);
    eventManager.remove(document, 'mouseup', handleMouseUp as EventListener);
  ...
  function handleTouchEnd(event: TouchEvent): void {
    ...
    eventManager.remove(document, 'touchmove', handleTouchMove as EventListener);
    eventManager.remove(document, 'touchend', handleTouchEnd as EventListener);
    eventManager.remove(document, 'touchcancel', handleTouchEnd as EventListener);
  }
